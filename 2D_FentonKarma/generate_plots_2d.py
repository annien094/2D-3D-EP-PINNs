...
def plot_2D_cell(data_list, dynamics, model, fig_name):
    ...
    cell_x = round(dynamics.max_x*0.5)
    cell_y = round(dynamics.max_y*0.5)
    ...
    ## save figure
#    png1 = io.BytesIO()
    plt.savefig(fig_name+"_cell_plot.png", format="png", dpi=500, pad_inches = .1, bbox_inches = 'tight')
...
def plot_2D_grid(data_list,dynamics, model, fig_name):
    ...
    plt.savefig(fig_name + "_grid_plot_2D.png", format="png", dpi=500, pad_inches = .1, bbox_inches = 'tight' )
    ## save figure
#    png1 = io.BytesIO()
