...
num_hidden_layers_2d = 4#5 # number of hidden layers for NN (2D)
hidden_layer_size_2d = 32#60 # size of each hidden layers (2D)
output_2d = 2 # network output size (2D)
output_heter = 2 # network output size for heterogeneity case (2D)
...
if inverse_string:
    ...
    checker = dde.callbacks.ModelCheckpoint(out_path+"model.ckpt", save_better_only=True, period=1000)
